const animeList = [
  ...
  },
  {
    ...
    posterImage: {
      ...
      orignal: "https://media.kitsu.io/anime/poster_images/41024/original.jpg",
    },
  ...
  },
  {
    ...
    posterImage: {
      ...
      orignal: "https://media.kitsu.io/anime/poster_images/44297/original.jpg",
    },
  ...
  },
  {
    ...
    posterImage: {
      ...
      orignal: "https://media.kitsu.io/anime/poster_images/44393/original.jpg",
    },
...
/**
 * Returns AnimeData Object based on slug
 * @param {String} slug
 */
const getAnimeDataFromSlug = (slug) => {
  //TODO Integrate with actual API

  const resultSet = animeList.filter((anime) => anime.slug === slug);
  if (resultSet.length > 0) {
    return resultSet[0];
  } else {
    console.warn(`No anime found for search slug :: ${slug}`);
    return null;
  }
};

export { getAnimeDataFromSlug };
